...
const ConfirmDelete = ({deleteBlog, blog, hideConfirmDelete}) => {
  return (
    <div
      id='alert-additional-content-2'
      className='py-12 px-12 ml-56 bg-red-100 rounded-lg dark:bg-red-200'
      role='alert'>
      <div className='flex items-center'>
        ...
        <h3 className='text-lg font-medium text-red-700 dark:text-red-800'>
          You are about to delete your blog!
        </h3>
      </div>
